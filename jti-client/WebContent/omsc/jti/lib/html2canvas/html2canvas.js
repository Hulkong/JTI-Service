...
var FEATURES = {
    ...
    get SUPPORT_SVG_DRAWING() {
        'use strict';
        console.log('testSVG' + testSVG(document));
    ...
    _createClass(Renderer, [{
        ...
        value: function renderStack(stack) {
            ...
            if (stack.container.isVisible()) {
                ...
                if (_transform !== null) {
                	if(stack.container.tagName == 'svg') {
                		console.log(stack);

                		console.log(stack.container.image);
                		console.log(_transform.transform);
                		console.log(stack.container.bounds);
                		//_transform.transform[5] +=  stack.container.bounds.top;
                		//stack.container.bounds.top = 0;
                		console.log(stack.container.bounds.left  + ' : ' + _transform.transformOrigin[0].value);
                		console.log(stack.container.bounds.top + ' : ' + _transform.transformOrigin[1].value);
                		
                		var tempTopOffset = 40;
                		_transform.transform[5] += tempTopOffset;
                		stack.container.bounds.top -= tempTopOffset;

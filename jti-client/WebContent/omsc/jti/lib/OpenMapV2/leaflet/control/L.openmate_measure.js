...
L.vTooltip = L.Tooltip.extend({
	...
	finishContent: function (prefix , subtext) {
		...
		this._container.innerHTML =prefix+' : <span class="leaflet-draw-tooltip-subtext">' + subtext + '</span> <a href="#" class="close"><img src=\"/omsc/jti/images/ic_tooltip_close.png\"/></a>' + '<br />' ;
		return this;
	},
